...
```{r fit1_diagnostic, echo=FALSE, fig.cap="Figure S11: Distribution of p-values and moderated t-statistics for the directly fitted model"}
...
```{r fit2_voom, fig.cap="Figure S12: Mean-variance relationship at individual observation-by-gene level"}
...
```{r fit2_diagnostic, echo=FALSE, fig.cap="Figure S13: Distribution of p-values and moderated t-statistics for the model with voom weights"}
par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
```{r fit4_diagnostic, echo=FALSE, fig.cap="Figure S14: Distribution of p-values and moderated t-statistics for the model with known covariates and SVA"}
par(mfrow = c(1, 2), mar = c(4, 5, 2, 2))
...
```{r volcanoPlot, echo=FALSE, fig.height=10, fig.width=20, out.height="500px", fig.cap="Figure S15: Volcano plots for models 2 and 4"}
...
```{r maPlot, echo=FALSE, fig.height=7, fig.width=9, out.height="500px", fig.cap="Figure S16: MA-plot for model 4"}
par(mfrow=c(1, 1))
